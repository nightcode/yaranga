...
/**
 * An arithmetic schedule.
 */
public class ArithmeticSchedule implements RetrySchedule {

  private final long minDelayMs;
  private final long maxDelayMs;
  private final long maxAttempts;

  public ArithmeticSchedule(long minDelayMs, long maxDelayMs) {
    if (minDelayMs <= 0L) {
  ...
  @Override public long nextDelayMs(long attempt) {
    ...
    return Math.min(minDelayMs * (attempt + 1), maxDelayMs);
  }
}
