 ...
 */
public class GeometricSchedule implements RetrySchedule {

  private final long minDelayMs;
  private final long maxDelayMs;
  private final long maxAttempts;

  public GeometricSchedule(long minDelayMs, long maxDelayMs) {
    if (minDelayMs <= 0L) {
  ...
  @Override public long nextDelayMs(long attempt) {
    ...
    return Math.min(minDelayMs * (1L << attempt), maxDelayMs);
  }
}
