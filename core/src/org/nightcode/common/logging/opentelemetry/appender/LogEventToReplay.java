...
class LogEventToReplay implements LogEvent {
  ...
  @Override public LogEvent toImmutable() {
    return null;
  }

  @Override public Map<String, String> getContextMap() {
    return emptyMap();
  }

  @Override public ReadOnlyStringMap getContextData() {
    return contextData;
  }

  @Override public @Nullable ThreadContext.ContextStack getContextStack() {
    return null;
  }

  @Override public String getLoggerFqcn() {
    return null;
  }
  ...
  @Override public long getTimeMillis() {
    return 0;
  }
  ...
  @Override public StackTraceElement getSource() {
    return source;
  }
  ...
  @Override public Throwable getThrown() {
    return thrown;
  }
  ...
  @Override public boolean isIncludeLocation() {
    return false;
  }
